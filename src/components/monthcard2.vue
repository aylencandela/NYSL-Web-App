          ...
          <div class="contenedor">
            <div class="myCard">
              ...
              <div id="description">
                ...
                <div id="info">
                  <ul>
                    <li><i class="fa fa-calendar-o" aria-hidden="true"></i>{{game.date}}</li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i>{{game.time}}</li>
                    <li><i class="fa fa-map-marker" aria-hidden="true"></i>{{game.location}}</li>
